...
export default function Page() {
	...
	return (
		<div className="p-6">
			...
			<p className="text-gray-600 mt-4">
				Sharer: The name of the sharer who sold the car.
			</p>
			<p className="text-gray-600 mt-4">
				Commission (%): The percentage of commission paid to the sharer.
			</p>
			<p className="text-gray-600 mt-4">
				Commission THB: The amount of commission paid to the sharer in THB.
			</p>
			<p className="text-gray-600 mt-4">
				Company Revenue: The amount of revenue generated by the sale of the car.
			</p>
			<p className="text-gray-600 mt-4">
				Sold Date: The date the car was sold.
			</p>
		</div>
	);
}
