...
import { UpdateCarSharerSchema, type UpdateCarSharerValues } from '../validation';
...
export default function EditCarSharerForm({ car, onClose }: EditCarSharerFormProps) {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <FieldSet>
                <FieldGroup className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {/* 7hrs Profit Amount */}
                    <Field>
                        <FieldLabel htmlFor="companyProfitAmount">7hrs Profit Amount</FieldLabel>
                        <InputGroup>
                            <InputGroupInput
                    ...
                    <Field>
                        <FieldLabel htmlFor="sharerProfitAmount">Sharer Profit Amount</FieldLabel>
                        <InputGroup>
                            <InputGroupInput
            ...
            <div className="flex justify-end gap-3 pt-4 border-t">
                <Button
                    ...
                    disabled={updateCarSharerMutation.isPending || form.formState.isSubmitting}
                >
                    Cancel
                </Button>
                <Button
